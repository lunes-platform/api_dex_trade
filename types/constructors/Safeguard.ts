...
import { ContractFile } from '../contract-info/Safeguard';
...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.AccountId | null } pairPsp22,
	*/
   	async "new" (
		pairPsp22: ArgumentTypes.AccountId | null,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, pairPsp22);
			let response;

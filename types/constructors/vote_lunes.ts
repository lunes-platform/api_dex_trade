...
import { ContractFile } from '../contract-info/vote_lunes';
...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.AccountId | null } ownerProject,
	* @param { (string | number | BN) } price,
	*/
   	async "new" (
		ownerProject: ArgumentTypes.AccountId | null,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, ownerProject, price);
			let response;

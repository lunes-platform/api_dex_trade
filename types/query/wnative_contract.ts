...
export default class Methods {
	...
	*/
	"transferEvent" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "transferEvent", [from, to, amount], __options , (result) => { return handleReturnType(result, getTypeDescription(3, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"approvalEvent" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "approvalEvent", [owner, spender, amount], __options , (result) => { return handleReturnType(result, getTypeDescription(3, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"withdraw" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "wnative::withdraw", [amount], __options , (result) => { return handleReturnType(result, getTypeDescription(9, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"deposit" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "wnative::deposit", [], __options , (result) => { return handleReturnType(result, getTypeDescription(9, DATA_TYPE_DESCRIPTIONS)); });
	}

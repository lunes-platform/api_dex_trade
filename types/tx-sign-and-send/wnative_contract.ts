...
export default class Methods {
	...
	*/
	"transferEvent" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "transferEvent", (events: EventRecord) => {
	...
	*/
	"approvalEvent" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "approvalEvent", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, EVENT_DATA_TYPE_DESCRIPTIONS);

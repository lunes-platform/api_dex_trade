...
import { ContractAbi } from '../contract-info/wnative_contract';
import QueryMethods from '../query/wnative_contract';
import BuildExtrinsicMethods from '../build-extrinsic/wnative_contract';
import TxSignAndSendMethods from '../tx-sign-and-send/wnative_contract';
import MixedMethods from '../mixed-methods/wnative_contract';
import EventsClass from '../events/wnative_contract';

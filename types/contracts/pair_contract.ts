...
import { ContractAbi } from '../contract-info/pair_contract';
import QueryMethods from '../query/pair_contract';
import BuildExtrinsicMethods from '../build-extrinsic/pair_contract';
import TxSignAndSendMethods from '../tx-sign-and-send/pair_contract';
import MixedMethods from '../mixed-methods/pair_contract';
import EventsClass from '../events/pair_contract';

...
export class RouterErrorBuilder {
	...
	static LangError(value: LangError): RouterError {
		return {
			langError: value,
		};
	}
	static TransferError(): RouterError {
		return {
			transferError: null,
		};
	}
...
export enum HelperError {
	identicalAddresses = 'IdenticalAddresses',
	...
	divByZero2 = 'DivByZero2',
	castOverflow2 = 'CastOverflow2',
